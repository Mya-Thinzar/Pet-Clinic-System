...
<form action="paymentPath" method="post">
	Enter Voucher No:
		<input type="text" name="frmVoucherNo" value=""/><br>
	Enter Payment Date:
		<input type="text" name="frmPaymentDate" value=""/><br>
	Enter Payment Amount:
		<input type="text" name="frmPaymentAmt" value=""/><br>
	Choose Payment Status:
	<input type='radio' name="frmPaymentStatus" value="cash">cash
	<input type='radio' name="frmPaymentStatus" value="card">card<br>
